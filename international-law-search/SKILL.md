...
- Do not begin retrieval before the user approves the search plan. Urgency does not bypass approval; offer a concise provisional plan when time is limited.
...
1. Read [intake-and-approval.md](references/intake-and-approval.md) before inspecting authorized context, scoping the request, or requesting approval for a written search plan.
2. Read [source-strategy.md](references/source-strategy.md) before searching primary sources and secondary scholarship.
3. Read [access-and-privacy.md](references/access-and-privacy.md) before using local materials, institutional access, subscription resources, or external queries.
